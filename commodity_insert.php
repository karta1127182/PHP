...
if(isset($_POST['checkme'])){
    ...
    $sql = "INSERT INTO `commodity` ( 
        ...
        , `rentState`, `rentAssign`, `shopAddressSelect`,`shopName`,`pImg`,`pImg2`,`pImg3`) VALUES 
      (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?)";
...
//        ]);
    ...
    window.alert('資料新增成功');
    window.location.href='commodity_insert.php';
    </script>");
                }        
        else{
                $msg=[
...
<!--                    <button type="button" class="btn btn-primary"onclick="history.back(-2)">返回上一頁</button>-->
                    <form name="form1" method="post" onsubmit="return checkForm()"enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <label for="pRent">車商資訊</label>
                            <input type="text" class="form-control" id="shopName" name="shopName" placeholder="請輸入車商資訊"
                            >
                        ...
                        <div class="form-group ">
                            ...
                            <img id="myimg" src="uploads/" alt="" style="object-fit:contain" width="400px" height="200px">
                            <input type="file" name="pImg" id="pImg" accept="image/jpeg,image/jpg,image/gif,image/png" multiple ><br>
                            <img id="myimg2" src="uploads/" alt="" style="object-fit:contain" width="400px" height="200px">
                            <input type="file" name="pImg2" id="pImg2" accept="image/jpeg,image/jpg,image/gif,image/png" multiple><br>
                            <img id="myimg3" src="uploads/" alt="" style="object-fit:contain" width="400px" height="200px">
...
<script>
    ...
    pImg.addEventListener('change', event=>{
        ...
        fetch('a20190313_04_upload_ajax4.php', {
            method: 'POST',
            body: fd
        })
    ...
    pImg2.addEventListener('change', event=>{
        ...
        fetch('a20190313_04_upload_ajax5.php', {
            method: 'POST',
            body: fd
        })
            .then(response=>response.json())
    ...
    pImg3.addEventListener('change', event=>{
        console.log(event.target);
        const fd = new FormData();
        ...
        fetch('a20190313_04_upload_ajax6.php', {
            method: 'POST',
            body: fd
        })
            .then(response=>response.json())
    ...
    let shopName= document.form1.shopName.value;
        ...
        // }
            ...
            if (shopName===''){
            document.querySelector('#shopNameHelp').innerHTML='請填入車商資訊!!!';
            document.form1.shopName.style.borderColor='red';
            isPassed=false;
        };
            return isPassed;
    };
