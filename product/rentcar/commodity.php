...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="commodity_insert.php"><i class="fas fa-plus-square">新增商品</i></a>
            <table class="table ">
                ...
                <tbody id="data_body">
                    ...
                    <tr>
                        ...
                        <td><img id="" src="<?= 'uploads/'.$row['pImg']?>" alt="" width="100px" height="100px">
                            <img id="" src="<?= 'uploads/'.$row['pImg2'] ?>" alt="" width="0px" height="0px ">
                            <img id="" src="<?= 'uploads/'.$row['pImg3']?>" alt="" width="0px" height="0px">
                        </td>
                 

                        <td><a  href="commodity_edit.php?pNo=<?= $row["pNo"] ?>"><i class="fas fa-edit"></i></a></td>
                        <td><a href="javascript: delete_it(<?= $row['pNo'] ?>)"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                        <?php endforeach; ?>
                </tbody>
            </table>
