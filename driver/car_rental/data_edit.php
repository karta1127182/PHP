                ...
                <div class="card-body">
                    ...
                    <form method="post" name="form1" onsubmit="return checkForm();">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="driverPhotoName" name="driverPhotoName" value="<?= $row['driverPhotoName'] ?>" style="display: block">
                            <img id="myimg" src="upload/<?= $row['driverPhotoName'] ?>" alt="" width="200px"><br>
