...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 page">
            <a href="data_insert.php" class="driver-insert"><i class="fas fa-plus-circle"></i></a>
    ...
    <div class="row tablerow">
        <div class="">
            <table class="table table-striped table-bordered" id="table1">
                ...
                <tr>
                    <td>
                        <a href="data_edit.php?driverNo=<?= $row['driverNo'] ?>"><i class="fas fa-edit"></i></a>
                    </td>
                    ...
                    <td><img id="myimg" src="upload/<?= $row['driverPhotoName'] ?>" alt="" width="100px"></td>
                    <td>
                        <a href="javascript:delete_it(<?= $row['driverNo'] ?>)">
    ...
    <div class="row">
        <?php foreach ($rows as $row): ?>
            ...
            <div class="card col-md-4 col-sm-12 col-xs-12" id="everycard" style="width: 18rem;">
                <img id="myimg" src="<?= 'upload/' . $row['driverPhotoName'] ?>" class="card-img-top mt-2" alt="...">

                <div class="d-flex justify-content-end">
                    <a href="data_edit.php?driverNo=<?= $row['driverNo'] ?>" class="m-2 s-icon"><i
...
<script>
    ...
    function delete_it(driverNo){
        if(confirm(`確定要刪除駕駛編號為 ${driverNo} 的資料嗎？`)){
            location.href = 'data_delete.php?driverNo=' + driverNo;
        }
    }
