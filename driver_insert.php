                ...
                <div class="card-body">
                    ...
                    <form method="post" name="form1" enctype="multipart/form-data" onsubmit="return checkForm();">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="driverPhotoName" name="driverPhotoName" value="" style="display: block">
                            <img id="myimg" src="uploads/" alt="" width="200px"><br>
