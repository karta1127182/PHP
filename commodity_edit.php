                ...
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="return checkForm()">
                        ...
                        <div class="form-group">
                            ...
                            1.<img id="myimg" src="uploads/<?= $row['pImg']?>" alt="" style="object-fit:contain" width="400px" height="200px"><br>
                            2.<img id="myimg2" src="uploads/<?= $row['pImg2']?>" alt="" style="object-fit:contain" width="400px" height="200px"><br>
                            3.<img id="myimg3" src="uploads/<?= $row['pImg3']?>" alt="" style="object-fit:contain" width="400px" height="200px"><br>
